...
For a particle in a 1D box of length L, the wavefunction for the ground state is $\Psi(x) = \sqrt{2/L} \sin(\pi x/L)$. Calculate the probability of finding the particle in the region $0 \le x \le L/4$.
