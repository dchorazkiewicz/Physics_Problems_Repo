...
* Rozważ przypadek $m_1 = m_2$.
* Rozważ granicę $m_2 \gg m_1$.
* Zinterpretuj fizycznie wyniki.
...
* Wykonaj symulację numeryczną.
* Porównaj rozwiązanie analityczne i numeryczne.
...
* Wyznacz siłę jako gradient potencjału.
...
* Rozwiąż numerycznie dla wybranych parametrów.
* Zbadaj wpływ energii początkowej na typ ruchu.
* Wykonaj wizualizację $x(t)$ oraz portret fazowy.
